...
export const translations = {
  en: {
    ...
    importVideoMetadataError: 'Could not read this video duration. Please choose a different video file.',
    navRecord: 'RECORD',
    navEdit: 'EDIT',
    ...
    camUnsupportedWebView: 'This Android WebView does not expose camera capture to the app. Please update Android System WebView/Chrome, check device camera availability, or use the web version in Chrome.',
    ...
    permissionPanelTitle: 'Permission Check',
    permissionPanelDesc: 'Grant camera/microphone and save permissions before recording or exporting video.',
    permissionCameraLabel: 'Camera',
    permissionStorageLabel: 'Photo / video save',
    permissionCameraButton: 'Allow Camera',
    permissionCameraRefresh: 'Refresh Camera',
    permissionStorageButton: 'Allow Save Access',
    permissionStorageWebButton: 'Web Download Save',
    permissionGranted: 'Allowed',
    permissionNotGranted: 'Not Allowed',
    permissionDenied: 'Denied',
    permissionChecking: 'Checking',
    permissionError: 'Error',
    permissionCameraGranted: 'Camera and microphone are allowed.',
    permissionCameraDenied: 'Camera or microphone permission was denied. Please enable it in app or browser settings.',
    permissionCameraError: 'Could not confirm camera permission. Check the device camera and browser settings.',
    permissionStorageGranted: 'Save permission is allowed.',
    permissionStorageDenied: 'Save permission is not allowed. Please enable storage/media access in app settings.',
    permissionStorageError: 'Could not confirm save permission.',
    permissionStorageWeb: 'Web version saves videos by browser download.',
    retry: 'Retry',
    newState: 'New State',
  ...
  ja: {
    ...
    importVideoMetadataError: 'この動画の長さを読み取れませんでした。別の動画ファイルを選択してください。',
    navRecord: 'レコード',
    navEdit: 'エディット',
    navSettings: '設定',
    camUnsupported: 'お使いの環境ではカメラ機能がサポートされていません。アプリを新しいタブで開くか、HTTPS環境で開いているか確認してください。',
    camUnsupportedWebView: 'このAndroid WebViewではアプリからカメラを利用できません。Android System WebView/Chromeを更新し、端末のカメラを確認するか、ChromeのWeb版をご利用ください。',
    ...
    permissionPanelTitle: '権限を確認する',
    permissionPanelDesc: '録画・書き出し前にカメラ/マイクと写真・動画保存の権限を確認してください。',
    permissionCameraLabel: 'カメラ',
    permissionStorageLabel: '写真/動画保存',
    permissionCameraButton: 'カメラを許可',
    permissionCameraRefresh: 'カメラを再確認',
    permissionStorageButton: '保存を許可',
    permissionStorageWebButton: 'Webではダウンロード保存',
    permissionGranted: '許可済み',
    permissionNotGranted: '未許可',
    permissionDenied: '拒否',
    permissionChecking: '確認中',
    permissionError: 'エラー',
    permissionCameraGranted: 'カメラとマイクが許可されました。',
    permissionCameraDenied: 'カメラまたはマイクの権限が拒否されました。アプリまたはブラウザ設定で許可してください。',
    permissionCameraError: 'カメラ権限を確認できませんでした。端末のカメラとブラウザ設定を確認してください。',
    permissionStorageGranted: '保存権限が許可されました。',
    permissionStorageDenied: '保存権限が未許可です。アプリ設定でストレージ/メディアアクセスを許可してください。',
    permissionStorageError: '保存権限を確認できませんでした。',
    permissionStorageWeb: 'Web版ではブラウザのダウンロードとして保存します。',
    retry: '再試行',
    newState: '新規状態',
  ...
  zh: {
    ...
    startRecording: '开始录制',
    importFile: '从文件导入',
    importVideoMetadataError: '无法读取此视频时长。请选择其他视频文件。',
    navRecord: '录制',
    navEdit: '编辑',
    navSettings: '设置',
    camUnsupported: '您所在的环境不支持相机功能。请尝试在新标签页中打开应用，或确保在 HTTPS 环境下访问。',
    camUnsupportedWebView: '此 Android WebView 未向应用开放相机采集。请更新 Android System WebView/Chrome，检查设备相机，或使用 Chrome Web 版。',
    ...
    permissionPanelTitle: '检查权限',
    permissionPanelDesc: '录制或导出视频前，请确认相机/麦克风和照片/视频保存权限。',
    permissionCameraLabel: '相机',
    permissionStorageLabel: '照片/视频保存',
    permissionCameraButton: '允许相机',
    permissionCameraRefresh: '重新检查相机',
    permissionStorageButton: '允许保存权限',
    permissionStorageWebButton: 'Web 下载保存',
    permissionGranted: '已允许',
    permissionNotGranted: '未允许',
    permissionDenied: '已拒绝',
    permissionChecking: '检查中',
    permissionError: '错误',
    permissionCameraGranted: '相机和麦克风已允许。',
    permissionCameraDenied: '相机或麦克风权限被拒绝。请在应用或浏览器设置中启用。',
    permissionCameraError: '无法确认相机权限。请检查设备相机和浏览器设置。',
    permissionStorageGranted: '保存权限已允许。',
    permissionStorageDenied: '保存权限未允许。请在应用设置中启用存储/媒体访问。',
    permissionStorageError: '无法确认保存权限。',
    permissionStorageWeb: 'Web 版会通过浏览器下载保存视频。',
    retry: '重试',
    newState: '新状态',
